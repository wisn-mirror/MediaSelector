...
public class VideoViewAndPhotoView extends FrameLayout {
    ...
    public void initView(Context context) {
        ...
        FrameLayout.LayoutParams fullScreeVideoViewParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        FrameLayout.LayoutParams photoViewsParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
